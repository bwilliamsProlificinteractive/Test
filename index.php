                ...
                <div class="connect-section">
                    ...
                    <div class="connect-form-wrapper">
                        <form class="connect-form" action="https://webto.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="POST">
                            <input type="hidden" id="_wpnonce" name="_wpnonce" value="87cc160ca6" />
                            <input type="hidden" name="_wp_http_referer" value="/connect/" />
                            <div>
                                <div class="input-field">
                                    <input id="name1" placeholder="Jane Smith" type="text" name="name" required>
                                    <label for="name" data-error="Required">Name</label>
                                </div>
                                <div class="input-field input-field-interested-in">
                                    <select id="interest" name="interest1">
                                ...
                                <div class="input-field">
                                    <input id="company1" placeholder="Dream Partner" type="text" name="company" data-parsley-validate-if-empty="true" data-parsley-required-if-interest="New Business">
                                    <label for="company" data-error="Required">Company</label>
                                </div>
                                <div class="input-field">
                                    <input id="email1" placeholder="janesmith@dreampartner.com" type="email" name="email" required>
                                    <label for="email" data-error="Invalid Email">Email</label>
                                </div>
                                <div class="input-field input-field-message">
                                    <textarea id="message1" placeholder="Hi, Prolific!" name="message" class="materialize-textarea" required></textarea>
